...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u"resources/icon/unpin.png", QSize(), QIcon.Normal, QIcon.Off)
        icon.addFile(u"resources/icon/pin.png", QSize(), QIcon.Normal, QIcon.On)
        ...
        self.graphicsView.setStyleSheet(u"border:0px")
